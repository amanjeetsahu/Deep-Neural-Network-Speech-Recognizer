...
def bidirectional_rnn_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn = bidir_rnn =  Bidirectional(GRU(output_dim, return_sequences=True,
...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    bidir_rnn = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn', dropout= 0.2))(bn_cnn)
    # TODO: Add batch normalization
    bn_rnn1 = BatchNormalization(name='bn_rnn1')(bidir_rnn)
    bidir_rnn2 = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn', dropout= 0.2))(bn_rnn1)
    
    # TODO: Add batch normalization
    bn_rnn2 = BatchNormalization(name='bn_rnn2')(bidir_rnn2)
    bidir_rnn3 = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn', dropout= 0.2))(bn_rnn2)
    # TODO: Add batch normalization
    bn_rnn3 = BatchNormalization(name='bn_rnn3')(bidir_rnn3)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
